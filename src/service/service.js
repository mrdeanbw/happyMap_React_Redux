        ...
        <div className="page-wrap">
            <div className="first-slide first-slide-privacy">
                ...
                <div className="container">
                    <div className="title-h1">Privacy
                        <br />Statement </div>
                    <div className="static-block">
                        <div className="static-subtitle">WHAT DO WE DO WITH YOUR INFORMATION? </div>
            ...
            <div className="static-wrap">
                <div className="static-row">
                    <div className="container">
                        <div className="static-block">
                            <div className="static-subtitle">CONSENT</div>
                            <div className="static-txt">
                                <p className="title-h4">How do you get my consent?</p>
                                <p>When you provide us with personal information to complete a transaction, verify your credit card, place an order, arrange for a delivery or return a purchase, we imply that you consent to our collecting it and using it for that specific reason only.</p>
                                <p>If we ask for your personal information for a secondary reason, like marketing, we will either ask you directly for your expressed consent, or provide you with an opportunity to say no.</p>
                                <p>How do I withdraw my consent?</p>
                                <p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at enrick@thehappymaps.com or mailing us at: Happy Maps 2876 Westberry Dr, San Jose, CA, 95132, United States</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="static-row">
                    <div className="container">
                        <div className="static-block">
                            <div className="static-subtitle">DISCLOSURE</div>
                            <div className="static-txt">
                ...
                <div className="static-row">
                    <div className="container">
                        <div className="static-block">
                            <div className="static-subtitle">SHOPIFY</div>
                            <div className="static-txt">
                                ...
                                <p className="title-h4">Payment: </p>
                ...
                <div className="static-row">
                    <div className="container">
                        <div className="static-block">
                            <div className="static-subtitle">THIRD-PARTY SERVICES </div>
                            <div className="static-txt">
                ...
                <div className="static-row">
                    <div className="container">
                        <div className="static-block">
                            <div className="static-subtitle"> AGE OF CONSENT </div>
                ...
                <div className="static-row">
                    <div className="container">
                        <div className="static-block">
                            <div className="static-subtitle">CHANGES TO THIS PRIVACY POLICY</div>

                            <div className="static-txt">
                                <p>We reserve the right to modify this privacy policy at any time, so please review it frequently. Changes and clarifications will take effect immediately upon their posting on the website. If we make material changes to this policy, we will notify you here that it has been updated, so that you are aware of what information we collect, how we use it, and under what circumstances, if any, we use and/or disclose it.</p>
                                <p>If our store is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to sell products to you.</p>
                                <p className="title-h4">QUESTIONS AND CONTACT INFORMATION </p>
                                <p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at enrick@thehappymaps.com or by mail at Happy Maps</p>
                                <p><b>[Re: Privacy Compliance Officer] </b>
                                </p>
                                <p><b>[2876 Westberry Dr, San Jose, CA, 95132, United States]</b></p>
                            </div>
                        </div>
                    </div>
                </div>
